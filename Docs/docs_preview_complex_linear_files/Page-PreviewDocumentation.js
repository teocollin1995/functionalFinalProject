...
Elm.Docs.Version.make = function (_elm) {
   ...
   var insert = F2(function (y,list) {
      ...
      if (_p0.ctor === "[]") {
            ...
            var _p1 = _p0._0;
            return _U.cmp(y,_p1) > 0 ? A2($List._op["::"],
            _p1,
            A2(insert,y,_p0._1)) : A2($List._op["::"],y,list);
         }
   });
   var MinorPatch = F2(function (a,b) {
   ...
   var toDictHelp = F2(function (_p2,dict) {
      ...
      var update = function (maybeMinorPatch) {
         ...
         if (_p4.ctor === "Nothing") {
               ...
               return $Maybe.Just(A2(MinorPatch,
               A2($Basics.max,_p5,current),
               A2(insert,A2($Basics.min,_p5,current),_p4._0.others)));
            }
      };
      return A3($Dict.update,_p3._0,update,dict);
   });
   var toDict = function (versions) {
      return A3($List.foldl,toDictHelp,$Dict.empty,versions);
   };
   ...
   var filterInteresting = function (versions) {
      return A2($List.map,
      $Basics.uncurry(toLatest),
      $Dict.toList(toDict(versions)));
   };
   var vsnToString = function (_p9) {
      ...
      ".",
      A2($Basics._op["++"],
      $Basics.toString(_p10._1),
      A2($Basics._op["++"],".",$Basics.toString(_p10._2)))));
   };
   ...
   var fromString = function (str) {
      ...
      if (_p12.ctor === "Ok" && _p12._0.ctor === "::" && _p12._0._1.ctor === "::" && _p12._0._1._1.ctor === "::" && _p12._0._1._1._1.ctor === "[]")
      {
            ...
            str,
            " is not a valid Elm version"));
         }
   };
   var fromStringList = function (versions) {
      return all(A2($List.map,fromString,versions));
   };
   var realMax = F2(function (rawVsn,allRawVsns) {
      var _p13 = A3($Result.map2,
      F2(function (v0,v1) {
         return {ctor: "_Tuple2",_0: v0,_1: v1};
      }),
      fromString(rawVsn),
      fromStringList(allRawVsns));
      if (_p13.ctor === "Ok" && _p13._0.ctor === "_Tuple2") {
            var _p14 = _p13._0._0;
            var maxVersion = A3($List.foldl,$Basics.max,_p14,_p13._0._1);
            return _U.eq(_p14,
            maxVersion) ? $Maybe.Nothing : $Maybe.Just(vsnToString(maxVersion));
         } else {
            return $Maybe.Nothing;
         }
   });
...
Elm.Docs.Name.make = function (_elm) {
   ...
   var toLink = F2(function (dict,_p0) {
      ...
      var _p4 = _p1.name;
      var _p3 = _p1.home;
      var _p2 = A2($Maybe.map,
      $Set.member(_p4),
      A2($Dict.get,_p3,dict));
      if (_p2.ctor === "Just" && _p2._0 === true) {
            var link = A2($Basics._op["++"],
            A2($String.map,
            function (c) {
               return _U.eq(c,_U.chr(".")) ? _U.chr("-") : c;
            },
            _p3),
            A2($Basics._op["++"],"#",_p4));
            return A2($Html.a,
            _U.list([$Html$Attributes.href(link)]),
            _U.list([$Html.text(_p4)]));
         } else {
            return $Html.text(_p4);
         }
   });
   var Canonical = F2(function (a,b) {
      return {home: a,name: b};
   });
   return _elm.Docs.Name.values = {_op: _op
                                  ,Canonical: Canonical
                                  ,toLink: toLink};
};
Elm.Utils = Elm.Utils || {};
...
Elm.Utils.Code.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var equals = A2($Html.span,
   _U.list([]),
   _U.list([$Html.text("=")]));
   var colon = A2($Html.span,
   _U.list([]),
   _U.list([$Html.text(":")]));
   var arrow = A2($Html.span,
   _U.list([]),
   _U.list([$Html.text("->")]));
   var space = $Html.text(" ");
   var padded = function (html) {
      return _U.list([space,html,space]);
   };
   var addParens = function (list) {
      return A2($List._op["::"],
      $Html.text("("),
      A2($Basics._op["++"],list,_U.list([$Html.text(")")])));
   };
   var keyword = function (kw) {
      return A2($Html.span,
      _U.list([$Html$Attributes.$class("hljs-keyword")]),
      _U.list([$Html.text(kw)]));
   };
   return _elm.Utils.Code.values = {_op: _op
                                   ,keyword: keyword
                                   ,addParens: addParens
                                   ,space: space
                                   ,padded: padded
...
Elm.Docs.Type.make = function (_elm) {
   ...
   var toHtml = F3(function (nameDict,context,tipe) {
      var go = F2(function (ctx,t) {
         return A3(toHtml,nameDict,ctx,t);
      });
      var _p0 = tipe;
      switch (_p0.ctor)
      {case "Function": var argsHtml = A2($List.concatMap,
           function (arg) {
              return A2($Basics._op["++"],
              A2(go,Func,arg),
              $Utils$Code.padded($Utils$Code.arrow));
           },
           _p0._0);
           ...
           return maybeAddParens(A2($Basics._op["++"],
           argsHtml,
           A2(go,Func,_p0._1)));
         ...
         case "Apply": if (_p0._1.ctor === "[]") {
                 ...
                 var argsHtml = A2($List.concatMap,
                 function (arg) {
                    return A2($List._op["::"],$Utils$Code.space,A2(go,App,arg));
                 },
                 _p0._1);
                 var maybeAddParens = function () {
                    var _p2 = context;
                 ...
                 return maybeAddParens(A2($List._op["::"],
                 A2($Docs$Name.toLink,nameDict,_p0._0),
                 argsHtml));
              }
         case "Tuple":
         return $Utils$Code.addParens($List.concat(A2($List.intersperse,
           _U.list([$Html.text(", ")]),
           A2($List.map,go(Other),_p0._0))));
         default: var fieldsHtml = $List.concat(A2($List.intersperse,
           _U.list([$Html.text(", ")]),
           A2($List.map,fieldToHtml(nameDict),_p0._0)));
           var recordInsides = function () {
              ...
              if (_p3.ctor === "Nothing") {
                    ...
                    return A2($List._op["::"],
                    $Html.text(_p3._0),
                    A2($List._op["::"],$Html.text(" | "),fieldsHtml));
                 }
           }();
           return A2($List._op["::"],
           $Html.text("{ "),
   ...
   var fieldToHtml = F2(function (nameDict,_p4) {
      ...
      A2($List._op["::"],
      $Utils$Code.space,
      A3(toHtml,nameDict,Other,_p5._1)))));
   });
   var length = F2(function (context,tipe) {
      var _p6 = tipe;
      switch (_p6.ctor)
      {case "Function": var argLengths = A2($List.map,
           function (t) {
              return 4 + A2(length,Func,t);
           },
           _p6._0);
           var parens = function () {
              var _p7 = context;
         ...
         case "Apply": if (_p6._1.ctor === "[]") {
                 ...
                 var argsLength = $List.sum(A2($List.map,
                 function (t) {
                    return 1 + A2(length,App,t);
                 },
                 _p6._1));
                 var parens = function () {
                    var _p8 = context;
         ...
         case "Tuple": return $List.sum(A2($List.map,
           function (t) {
              return 2 + A2(length,Other,t);
           },
           _p6._0));
         default: var extLength = function () {
           ...
           var fieldLength = function (_p10) {
              var _p11 = _p10;
              return $String.length(_p11._0) + 3 + A2(length,Other,_p11._1);
           };
           var recordLength = 2 + $List.sum(A2($List.map,
           function (ft) {
...
Elm.Utils.Markdown.make = function (_elm) {
   ...
   if (_elm.Utils.Markdown.values)
   return _elm.Utils.Markdown.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var myOptions = function () {
      var options = $Markdown.defaultOptions;
      return _U.update(options,
      {defaultHighlighting: $Maybe.Just("elm")});
   }();
   var block = function (raw) {
      return A2($Markdown.toHtmlWith,myOptions,raw);
   };
...
Elm.Docs.Entry.make = function (_elm) {
   ...
   var viewTag = F2(function (tipeToHtml,_p0) {
      ...
      A2($List.map,tipeToHtml,_p1.args)));
   });
   var longFunctionAnnotation = F3(function (nameDict,
   args,
   result) {
      ...
      _U.list([$Html.text("    ")
              ,$Utils$Code.arrow
              ,$Utils$Code.space])));
      var tipeHtml = A2($List.map,
      A2($Docs$Type.toHtml,nameDict,$Docs$Type.Func),
      A2($Basics._op["++"],args,_U.list([result])));
      return A3($List.map2,
   ...
   var annotationBlock = function (bits) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("docs-annotation")]),
      $List.concat(A2($List.intersperse,
      _U.list([$Html.text("\n")]),
      bits)));
   };
   ...
   var nameToLink = function (name) {
      var humanName = A2($Regex.contains,
      operator,
      name) ? A2($Basics._op["++"],
      "(",
      A2($Basics._op["++"],name,")")) : name;
      return A2($Html.a,
      _U.list([$Html$Attributes.style(_U.list([A2(_op["=>"],
              "font-weight",
              "bold")]))
              ,$Html$Attributes.href(A2($Basics._op["++"],"#",name))]),
      _U.list([$Html.text(humanName)]));
   };
   var valueAnnotation = F3(function (nameDict,name,tipe) {
      var _p2 = tipe;
      if (_p2.ctor === "Function") {
            return _U.cmp($String.length(name) + 3 + A2($Docs$Type.length,
            $Docs$Type.Other,
            tipe),
            64) > 0 ? A2($List._op["::"],
            _U.list([nameToLink(name)]),
            A3(longFunctionAnnotation,
            nameDict,
            _p2._0,
            _p2._1)) : _U.list([A2($List._op["::"],
            nameToLink(name),
            A2($Basics._op["++"],
            $Utils$Code.padded($Utils$Code.colon),
            A3($Docs$Type.toHtml,nameDict,$Docs$Type.Other,tipe)))]);
         } else {
   ...
   var aliasAnnotation = F4(function (nameDict,name,vars,tipe) {
      var typeLines = function () {
         ...
         if (_p3.ctor === "Record") {
               ...
               var _p4 = function () {
                  ...
                  if (_p5.ctor === "Nothing") {
                        return {ctor: "_Tuple2"
                               ...
                               ,_1: A2($List._op["::"],
                               $Html.text("    { "),
                               A2($List.repeat,$List.length(_p6),$Html.text("    , ")))};
                     } else {
                        return {ctor: "_Tuple2"
                               ,_0: _U.list([_U.list([$Html.text("    { ")
                                                     ,$Html.text(_p5._0)
                                                     ,$Html.text(" |")])])
                               ,_1: A2($List._op["::"],
                               $Html.text("      | "),
               ...
               F2(function (x,y) {    return A2($List._op["::"],x,y);}),
               starters,
               A2($List.map,$Docs$Type.fieldToHtml(nameDict),_p6)),
   ...
   var typeView = F2(function (nameDict,model) {
      var annotation = function () {
         var _p7 = model.info;
         switch (_p7.ctor)
         {case "Value": return A3(valueAnnotation,
              nameDict,
              model.name,
              _p7._0);
            case "Union": return A4(unionAnnotation,
              A2($Docs$Type.toHtml,nameDict,$Docs$Type.App),
              model.name,
              _p7._0.vars,
              _p7._0.tags);
            default: return A4(aliasAnnotation,
              nameDict,
              model.name,
              _p7._0.vars,
              _p7._0.tipe);}
      ...
      _U.list([$Html$Attributes.$class("docs-entry")
              ,$Html$Attributes.id(model.name)]),
      _U.list([annotationBlock(annotation)
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("docs-comment")]),
              _U.list([$Utils$Markdown.block(model.docs)]))]));
   });
   var stringView = function (model) {
      var annotation = function () {
         ...
         {case "Value": return _U.list([A2($List._op["::"],
              ...
              A2($Basics._op["++"],
              $Utils$Code.padded($Utils$Code.colon),
              _U.list([$Html.text(_p8._0)])))]);
            case "Union": return A4(unionAnnotation,
              function (t) {
                 return _U.list([$Html.text(t)]);
              },
              model.name,
              _p8._0.vars,
              _p8._0.tags);
            default: return _U.list([A2(aliasNameLine,
                                    model.name,
                                    _p8._0.vars)
                                    ,_U.list([$Html.text("    "),$Html.text(_p8._0.tipe)])]);}
      }();
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("docs-entry")
              ,$Html$Attributes.id(model.name)]),
   ...
   var tagMap = F2(function (func,tag) {
      return _U.update(tag,{args: A2($List.map,func,tag.args)});
   });
   var update = F2(function (action,model) {
      return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
   });
   var Fixity = F2(function (a,b) {
   ...
   var map = F2(function (func,model) {
      var newInfo = function () {
         var _p9 = model.info;
         switch (_p9.ctor)
         {case "Value": return A2(Value,func(_p9._0),_p9._1);
            case "Union": return Union({vars: _p9._0.vars
                                       ,tags: A2($List.map,tagMap(func),_p9._0.tags)});
            default: return Alias({vars: _p9._0.vars
...
Elm.Docs.Package.make = function (_elm) {
   ...
   F2(function (vars,tipe) {
      return $Docs$Entry.Alias({vars: vars,tipe: tipe});
   }),
   A2($Json$Decode._op[":="],
   "args",
   $Json$Decode.list($Json$Decode.string)),
   A2($Json$Decode._op[":="],"type",tipe));
   var tag = A3($Json$Decode.tuple2,
   $Docs$Entry.Tag,
   $Json$Decode.string,
   $Json$Decode.list(tipe));
   var union = A3($Json$Decode.object2,
   F2(function (vars,tags) {
      return $Docs$Entry.Union({vars: vars,tags: tags});
   }),
   A2($Json$Decode._op[":="],
   "args",
   $Json$Decode.list($Json$Decode.string)),
   ...
   var value = A3($Json$Decode.object2,
   $Docs$Entry.Value,
   A2($Json$Decode._op[":="],"type",tipe),
   $Json$Decode.maybe(fixity));
   ...
   var dictBy = F2(function (f,list) {
      return $Dict.fromList(A2($List.map,
      function (x) {
         return {ctor: "_Tuple2",_0: f(x),_1: x};
      },
      list));
   });
   var Module = F3(function (a,b,c) {
   ...
   var decodeModule = function () {
      ...
      A2($Json$Decode._op[":="],
      "aliases",
      $Json$Decode.list(entry(alias))),
      A2($Json$Decode._op[":="],
      "types",
      $Json$Decode.list(entry(union))),
      A2($Json$Decode._op[":="],
      "values",
      $Json$Decode.list(entry(value))));
   }();
   var decodePackage = A2($Json$Decode.map,
   dictBy(function (_) {    return _.name;}),
   $Json$Decode.list(decodeModule));
   return _elm.Docs.Package.values = {_op: _op
...
Elm.Page.Context.make = function (_elm) {
   ...
   var pathTo = F2(function (_p0,file) {
      ...
      A2($Utils$Path._op["</>"],
      A2($Utils$Path._op["</>"],
      A2($Utils$Path._op["</>"],"/packages",_p1.user),
      _p1.project),
      _p1.version),
      file);
   });
   var getDocs = function (context) {
      return A2($Http.get,
      $Docs$Package.decodePackage,
      A2(pathTo,context,"documentation.json"));
   };
   var getReadme = function (context) {
      return $Http.getString(A2(pathTo,context,"README.md"));
   };
   var VersionContext = F5(function (a,b,c,d,e) {
      return {user: a
             ,project: b
             ,version: c
             ,allVersions: d
   ...
   var OverviewContext = F3(function (a,b,c) {
...
Elm.Route.make = function (_elm) {
   ...
   var Version = F3(function (a,b,c) {
      return {ctor: "Version",_0: a,_1: b,_2: c};
   });
   var Package = F2(function (a,b) {
      return {ctor: "Package",_0: a,_1: b};
   });
   var User = F2(function (a,b) {
      return {ctor: "User",_0: a,_1: b};
   });
   var Packages = function (a) {
      return {ctor: "Packages",_0: a};
   };
   var fromOverviewContext = function (ctx) {
      return A2(_op["=>"],
      Packages,
      A2(_op["=>"],
      User(ctx.user),
      A2(Package,ctx.project,$Maybe.Nothing)));
   };
   var fromVersionContext = function (ctx) {
      ...
      A2(_op["=>"],
      Package(ctx.project),
      A3(Version,ctx.version,ctx.allVersions,ctx.moduleName))));
   };
   var Help = {ctor: "Help"};
...
Elm.Component.Header.make = function (_elm) {
   ...
   var versionWarning = function (model) {
      var warning = function () {
         ...
         {
               var _p1 = A2($Docs$Version.realMax,
               _p0._0._0._1._0._1._0._0,
               _p0._0._0._1._0._1._0._1);
               if (_p1.ctor === "Nothing") {
                     return _U.list([]);
                  } else {
                     var _p2 = _p1._0;
                     var moduleName = A2($Maybe.withDefault,
                     "",
                     A2($Maybe.map,$Utils$Path.hyphenate,_p0._0._0._1._0._1._0._2));
                     ...
                     _U.list([$Html.text("Warning! The latest version of this package is ")
                             ...
                             A2($Utils$Path._op["</>"],
                             A2($Utils$Path._op["</>"],
                             A2($Utils$Path._op["</>"],"/packages",_p0._0._0._0),
                             _p0._0._0._1._0._0),
                             _p2),
                             moduleName))]),
      ...
      _U.list([$Html$Attributes.$class("header-underbar")]),
      warning)]);
   };
   ...
   var spacey = function (token) {
      return A2($Html.span,
      _U.list([$Html$Attributes.$class("spacey-char")]),
   ...
   var unrollModuleeRoute = F4(function (user,pkg,vsn,name) {
      return _U.list([spacey("/")
                     ...
                     A2($Utils$Path._op["</>"],
                     A2($Utils$Path._op["</>"],
                     A2($Utils$Path._op["</>"],"/packages",user),
                     pkg),
                     vsn),
   ...
   var unrollUserRoute = function (_p10) {
      ...
      return A2($List._op["::"],
      A2(headerLink,
      A2($Utils$Path._op["</>"],"https://github.com",_p12),
      _p12),
      A2(maybe,unrollPackageRoute(_p12),_p11._1));
   };
   ...
   var view = F3(function (_p14,model,contents) {
      ...
      _U.list([A2(center,"#eeeeee",_U.list([headerLinks(model)]))
              ...
              _U.list([$Html.text("All code for this site is open source and written in Elm. ")
                      ,A2($Html.a,
                      _U.list([$Html$Attributes.$class("grey-link")
                              ,$Html$Attributes.href("https://github.com/elm-lang/package.elm-lang.org/")]),
   ...
   var init = function (route) {
      return {ctor: "_Tuple2",_0: Model(route),_1: $Effects.none};
   };
...
Elm.Parse.Combinators.make = function (_elm) {
   ...
   if (_elm.Parse.Combinators.values)
   return _elm.Parse.Combinators.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   ...
   var map = F2(function (func,parser) {
      return A2(andThen,
      parser,
      function (a) {
         return succeed(func(a));
   ...
   var ignore1 = F2(function (x,parser) {
      return A3(map2,
      F2(function (_p0,a) {    return a;}),
      x,
      parser);
   });
   ...
   var ignore2 = F3(function (x,y,parser) {
      return A4(map3,
      F3(function (_p2,_p1,a) {    return a;}),
      x,
      y,
      parser);
   });
   var middle = F3(function (x,parser,y) {
      return A4(map3,
      F3(function (_p4,a,_p3) {    return a;}),
      x,
      parser,
      y);
   });
   ...
   var ignore3 = F4(function (x,y,z,parser) {
      return A5(map4,
      F4(function (_p7,_p6,_p5,a) {    return a;}),
      x,
      y,
      z,
      parser);
...
Elm.Parse.Type.make = function (_elm) {
   ...
   var buildFunction = F3(function (args,
   currentType,
   remainingTypes) {
      buildFunction: while (true) {
         var _p1 = remainingTypes;
         if (_p1.ctor === "[]") {
               return $List.isEmpty(args) ? currentType : A2($Docs$Type.Function,
               $List.reverse(args),
               currentType);
            } else {
               var _v2 = A2($List._op["::"],currentType,args),
               _v3 = _p1._0,
               _v4 = _p1._1;
               args = _v2;
               currentType = _v3;
   ...
   var spaces = A2($Parse$Combinators.map,
   $Basics.always({ctor: "_Tuple0"}),
   $Parse$Combinators.zeroOrMore($Parse$Combinators.$char(_U.chr(" "))));
   var commasLeading = function (parser) {
      return $Parse$Combinators.zeroOrMore(A4($Parse$Combinators.ignore3,
      spaces,
   ...
   var varChar = $Parse$Combinators.satisfy(function (c) {
      return $Char.isLower(c) || ($Char.isUpper(c) || (_U.eq(c,
      _U.chr("_")) || (_U.eq(c,_U.chr("\'")) || $Char.isDigit(c))));
   });
   var elmVarWith = function (starter) {
      return A2($Parse$Combinators.map,
      $String.fromList,
      A3($Parse$Combinators.map2,
      F2(function (x,y) {    return A2($List._op["::"],x,y);}),
      starter,
      $Parse$Combinators.zeroOrMore(varChar)));
   };
   var $var = A2($Parse$Combinators.map,
   $Docs$Type.Var,
   ...
   var nameHelp = function (seen) {
      ...
      function (str) {
         return $Parse$Combinators.oneOf(_U.list([A2($Parse$Combinators.ignore1,
                                                 $Parse$Combinators.$char(_U.chr(".")),
                                                 nameHelp(A2($List._op["::"],str,seen)))
                                                 ,$Parse$Combinators.succeed(A2($Docs$Name.Canonical,
                                                 A2($String.join,".",$List.reverse(seen)),
                                                 str))]));
      });
   };
   ...
   var field = $Parse$Combinators.lazy(function (_p2) {
      ...
      elmVarWith($Parse$Combinators.lower),
      A4($Parse$Combinators.ignore3,
      spaces,
      $Parse$Combinators.$char(_U.chr(":")),
      spaces,
      tipe));
   });
   var tipe = $Parse$Combinators.lazy(function (_p3) {
      return A3($Parse$Combinators.map2,
      buildFunction(_U.list([])),
      tipeTerm,
      arrowTerms);
   });
   var arrowTerms = $Parse$Combinators.lazy(function (_p4) {
      return $Parse$Combinators.zeroOrMore(A4($Parse$Combinators.ignore3,
      spaces,
      $Parse$Combinators.string("->"),
      spaces,
      tipeTerm));
   });
   var tipeTerm = $Parse$Combinators.lazy(function (_p5) {
   ...
   var apply = $Parse$Combinators.lazy(function (_p6) {
      ...
      $Docs$Type.Apply,
      name,
      $Parse$Combinators.zeroOrMore(A2($Parse$Combinators.ignore1,
      spaces,
      applyTerm)));
   });
   var applyTerm = $Parse$Combinators.lazy(function (_p7) {
      return $Parse$Combinators.oneOf(_U.list([$var
                                              ...
                                              function (n) {
                                                 return A2($Docs$Type.Apply,n,_U.list([]));
                                              },
                                              name)
                                              ,record
                                              ,parenTipe]));
   ...
   var record = $Parse$Combinators.lazy(function (_p9) {
      ...
      $Parse$Combinators.$char(_U.chr("{")),
      spaces),
      $Parse$Combinators.oneOf(_U.list([A2($Parse$Combinators.andThen,
                                       elmVarWith($Parse$Combinators.lower),
                                       recordHelp)
                                       ,$Parse$Combinators.succeed(A2($Docs$Type.Record,
                                       _U.list([]),
                                       $Maybe.Nothing))])),
      A2($Parse$Combinators.ignore1,
      spaces,
   ...
   var recordHelp = function (lowerName) {
      return $Parse$Combinators.lazy(function (_p10) {
         ...
         $Parse$Combinators.oneOf(_U.list([A3($Parse$Combinators.map2,
                                          F2(function (t,rest) {
                                             return A2($Docs$Type.Record,
                                             A2($List._op["::"],{ctor: "_Tuple2",_0: lowerName,_1: t},rest),
                                             $Maybe.Nothing);
                                          }),
   ...
   var parse = function (tipeString) {
      return A2($Parse$Combinators.run,tipe,tipeString);
   };
...
Elm.Component.PackageDocs.make = function (_elm) {
   ...
   if (_elm.Component.PackageDocs.values)
   return _elm.Component.PackageDocs.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   var isValue = function (str) {
      ...
      $var,
      str) ? $Maybe.Just(str) : A2($Regex.contains,
      operator,
      str) ? $Maybe.Just(A2($String.dropLeft,
      1,
   ...
   var viewChunk = F2(function (entryView,chunk) {
      ...
      if (_p0.ctor === "Markdown") {
            return A2($Html.span,
            _U.list([$Html$Attributes.$class("markdown-entry")]),
            _U.list([$Utils$Markdown.block(_p0._0)]));
         } else {
   ...
   var view = F2(function (addr,model) {
      ...
      function () {
         var _p1 = model;
         switch (_p1.ctor)
         {case "Loading": return _U.list([A2($Html.p,
              _U.list([]),
              _U.list([$Html.text("Loading...")]))]);
            case "Failed": return _U.list([A2($Html.p,
                                          _U.list([]),
                                          _U.list([$Html.text("Documentation did not load.")]))
                                          ,A2($Html.p,
                                          _U.list([]),
            ...
            case "RawDocs": return A2($List._op["::"],
              A2($Html.h1,
              _U.list([$Html$Attributes.$class("entry-list-title")]),
            ...
            default: return A2($List._op["::"],
              ...
              _U.list([$Html.text(_p1._0.name)])),
              A2($List.map,
              viewChunk($Docs$Entry.typeView(_p1._0.nameDict)),
              _p1._0.chunks));}
      }());
   });
   _op["=>"] = F2(function (v0,v1) {
   ...
   var toNameDict = function (pkg) {
      return A2($Dict.map,
      F2(function (_p3,modul) {
         return $Set.fromList($Dict.keys(modul.entries));
      }),
      pkg);
   };
   var NoOp = {ctor: "NoOp"};
   var jumpToHash = $Effects.task(A2($Task.map,
   $Basics.always(NoOp),
   $Native$Jump.jump));
   var Fail = function (a) {    return {ctor: "Fail",_0: a};};
   var LoadReadme = function (a) {
      return {ctor: "LoadReadme",_0: a};
   };
   var LoadParsedDocs = function (a) {
      return {ctor: "LoadParsedDocs",_0: a};
   };
   var LoadDocs = F2(function (a,b) {
   ...
   var toEntry = F2(function (moduleDocs,name) {
      ...
      if (_p7.ctor === "Nothing") {
            ...
            {start: {line: 304,column: 3},end: {line: 309,column: 20}},
            _p7)(A2($Basics._op["++"],
   ...
   var delayedTypeParse = function (chunks) {
      ...
      function (_p10) {
         return $Task.succeed(LoadParsedDocs(A2($List.map,
         chunkMap(stringToType),
         chunks)));
      }));
   };
   var subChunksHelp = F2(function (moduleDocs,parts) {
      ...
      if (_p11.ctor === "[]") {
            ...
            if (_p12.ctor === "Just") {
                  return A2($List._op["::"],
                  A2(toEntry,moduleDocs,_p12._0),
                  A2(subChunksHelp,moduleDocs,_p17));
               } else {
                  ...
                  if (_p13.ctor === "[]") {
                        ...
                        if (_p14.ctor === "Just") {
                              return _U.list([A2(toEntry,moduleDocs,_p14._0)
                                             ,Markdown(A2($String.dropLeft,
                                             $String.length(_p15),
                                             A2($String.join,",",A2($List._op["::"],trimmedPart,_p17))))]);
                           } else {
                              return _U.list([Markdown(A2($String.join,",",parts))]);
                           }
                     }
   ...
   var subChunks = F2(function (moduleDocs,postDocs) {
      return A2(subChunksHelp,
      moduleDocs,
      A2($String.split,",",postDocs));
   });
   var toChunks = function (moduleDocs) {
      ...
      if (_p18.ctor === "[]") {
            ...
            return A2($List._op["::"],
            Markdown(_p18._0),
            A2($List.concatMap,subChunks(moduleDocs),_p18._1));
         }
   };
   var Info = F3(function (a,b,c) {
      return {name: a,nameDict: b,chunks: c};
   });
   var ParsedDocs = function (a) {
      return {ctor: "ParsedDocs",_0: a};
   };
   var RawDocs = function (a) {
   ...
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return {ctor: "_Tuple2"
                           ,_0: model
                           ,_1: $Effects.none};
         case "Fail": return {ctor: "_Tuple2"
                             ,_0: Failed(_p20._0)
                             ,_1: $Effects.none};
         case "LoadReadme": return {ctor: "_Tuple2"
                                   ,_0: Readme(_p20._0)
                                   ,_1: $Effects.none};
         case "LoadDocs": var _p23 = _p20._0;
           ...
           if (_p21.ctor === "Just") {
                 ...
                 return {ctor: "_Tuple2"
                        ,_0: RawDocs(A3(Info,_p23,toNameDict(_p22),chunks))
                        ,_1: delayedTypeParse(chunks)};
              } else {
                 return {ctor: "_Tuple2"
                        ,_0: Failed($Http.UnexpectedPayload(A2($Basics._op["++"],
         ...
         default: var _p24 = model;
           if (_p24.ctor === "RawDocs") {
                 return {ctor: "_Tuple2"
                        ,_0: ParsedDocs(_U.update(_p24._0,{chunks: _p20._0}))
                        ,_1: jumpToHash};
              } else {
                 return {ctor: "_Tuple2"
                        ,_0: Failed($Http.UnexpectedPayload("Something went wrong parsing types."))
                        ,_1: $Effects.none};
              }}
   });
   var Loading = {ctor: "Loading"};
   var init = function (context) {
      return {ctor: "_Tuple2",_0: Loading,_1: getContext(context)};
   };
...
Elm.Component = Elm.Component || {};
Elm.Component.PackagePreview = Elm.Component.PackagePreview || {};
Elm.Component.PackagePreview.make = function (_elm) {
   "use strict";
   _elm.Component = _elm.Component || {};
   _elm.Component.PackagePreview = _elm.Component.PackagePreview || {};
   if (_elm.Component.PackagePreview.values)
   return _elm.Component.PackagePreview.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   ...
   var docsForModule = F2(function (moduleName,docs) {
      var _p0 = A2($Dict.get,moduleName,docs);
      if (_p0.ctor === "Just") {
            var chunks = A2($List.map,
            $Component$PackageDocs.chunkMap($Component$PackageDocs.stringToType),
            $Component$PackageDocs.toChunks(_p0._0));
            return $Component$PackageDocs.ParsedDocs(A3($Component$PackageDocs.Info,
            moduleName,
            $Component$PackageDocs.toNameDict(docs),
            chunks));
         } else {
            return $Component$PackageDocs.Loading;
         }
   });
   _op["=>"] = F2(function (v0,v1) {
      return {ctor: "_Tuple2",_0: v0,_1: v1};
   });
   var instructions = function (md) {
      return A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([A2(_op["=>"],
      "width",
      "600px")]))]),
      _U.list([$Utils$Markdown.block(md)
              ,A2($Html.input,
              _U.list([$Html$Attributes.type$("file")
                      ,$Html$Attributes.id("fileLoader")
                      ,$Html$Attributes.style(_U.list([A2(_op["=>"],
                      "margin-left",
                      "1em")]))]),
              _U.list([]))]));
   ...
   var moduleLink = F2(function (address,moduleName) {
      return A2($Html.a,
      _U.list([A2($Html$Events.onClick,address,SwitchTo(moduleName))
              ,$Html$Attributes.$class("pkg-nav-module")
              ,$Html$Attributes.href(A2($Basics._op["++"],
              "#",
              $Utils$Path.hyphenate(moduleName)))]),
      _U.list([$Html.text(moduleName)]));
   });
   var moduleLinks = F2(function (address,modulesNames) {
      var moduleItem = function (moduleName) {
         return A2($Html.li,
         _U.list([]),
         _U.list([A2(moduleLink,address,moduleName)]));
      };
      return A2($List.map,moduleItem,modulesNames);
   });
   var viewSidebar = F2(function (address,modulesNames) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("pkg-nav")]),
      _U.list([A2($Html.ul,
      _U.list([$Html$Attributes.$class("pkg-nav-value")]),
      A2(moduleLinks,address,modulesNames))]));
   });
   var view = F2(function (address,model) {
      var _p1 = model;
      switch (_p1.ctor)
      {case "AwaitingFile": return _U.list([instructions($long)]);
         case "BadFile": var errorMsg = function () {
              var _p2 = _p1._0;
              if (_p2.ctor === "Just") {
                    return A2($Basics._op["++"],
                    "Problem uploading that file: ",
                    _p2._0);
                 } else {
                    return "Problem uploading that file, try it a different way.";
                 }
           }();
           return _U.list([instructions($long)
                          ,A2($Html.p,
                          _U.list([$Html$Attributes.style(_U.list([A2(_op["=>"],
                          "color",
                          "red")]))]),
                          _U.list([$Html.text(errorMsg)]))]);
         default: return _U.list([instructions($short)
                                 ,A2($Html.div,
                                 _U.list([$Html$Attributes.style(_U.list([A2(_op["=>"],
                                                                         "border-top",
                                                                         "1px solid #eeeeee")
                                                                         ,A2(_op["=>"],"margin-top","1em")]))]),
                                 _U.list([A2($Component$PackageDocs.view,
                                         A2($Signal.forwardTo,
                                         address,
                                         function (_p3) {
                                            return _U.crash("Component.PackagePreview",
                                            {start: {line: 107,column: 57}
                                            ,end: {line: 107,column: 68}})("TODO");
                                         }),
                                         _p1._1)
                                         ,A2(viewSidebar,address,$Dict.keys(_p1._0))]))]);}
   });
   var LoadDocs = function (a) {
      return {ctor: "LoadDocs",_0: a};
   };
   var Fail = function (a) {    return {ctor: "Fail",_0: a};};
   var NoOp = {ctor: "NoOp"};
   var GoodFile = F2(function (a,b) {
      return {ctor: "GoodFile",_0: a,_1: b};
   });
   var BadFile = function (a) {
   ...
   var update = F2(function (action,model) {
      ...
      function () {
         ...
         {case "NoOp": return model;
            case "Fail": return BadFile(_p4._0);
            case "LoadDocs": var _p6 = _p4._0;
              var _p5 = $List.head($Dict.keys(_p6));
              if (_p5.ctor === "Nothing") {
                    return BadFile($Maybe.Just("The JSON you uploaded does not have any modules in it!"));
                 } else {
                    return A2(GoodFile,_p6,A2(docsForModule,_p5._0,_p6));
                 }
            default: var _p7 = model;
              if (_p7.ctor === "GoodFile") {
                    var _p8 = _p7._0;
                    return A2(GoodFile,_p8,A2(docsForModule,_p4._0,_p8));
                 } else {
                    return model;
                 }}
      }());
   });
   var AwaitingFile = {ctor: "AwaitingFile"};
   var init = {ctor: "_Tuple2",_0: AwaitingFile,_1: $Effects.none};
   return _elm.Component.PackagePreview.values = {_op: _op
...
Elm.Page.PreviewDocumentation.make = function (_elm) {
   "use strict";
   _elm.Page = _elm.Page || {};
   _elm.Page.PreviewDocumentation = _elm.Page.PreviewDocumentation || {};
   if (_elm.Page.PreviewDocumentation.values)
   return _elm.Page.PreviewDocumentation.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Component$Header = Elm.Component.Header.make(_elm),
   $Component$PackagePreview = Elm.Component.PackagePreview.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Docs$Package = Elm.Docs.Package.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var UpdatePreview = function (a) {
      return {ctor: "UpdatePreview",_0: a};
   };
   var update = F2(function (action,model) {
      var _p0 = action;
      var _p1 = A2($Component$PackagePreview.update,
      _p0._0,
      model.preview);
      var newPreview = _p1._0;
      var fx = _p1._1;
      return {ctor: "_Tuple2"
             ,_0: _U.update(model,{preview: newPreview})
             ,_1: A2($Effects.map,UpdatePreview,fx)};
   });
   var view = F2(function (addr,model) {
      return A3($Component$Header.view,
      addr,
      model.header,
      A2($Component$PackagePreview.view,
      A2($Signal.forwardTo,addr,UpdatePreview),
      model.preview));
   });
   ...
   var init = function () {
      var _p2 = $Component$PackagePreview.init;
      var preview = _p2._0;
      var previewFx = _p2._1;
      var _p3 = $Component$Header.init($Route.Help);
      var header = _p3._0;
      var headerFx = _p3._1;
      return {ctor: "_Tuple2"
             ,_0: A2(Model,header,preview)
             ,_1: $Effects.batch(_U.list([headerFx
                                         ,A2($Effects.map,UpdatePreview,previewFx)]))};
   }();
   var uploads = Elm.Native.Port.make(_elm).inboundSignal("uploads",
   "String",
   function (v) {
      return typeof v === "string" || typeof v === "object" && v instanceof String ? v : _U.badPort("a string",
      v);
   });
   var docsUploads = function () {
      var toDocs = function (body) {
         var _p4 = A2($Json$Decode.decodeString,
         $Docs$Package.decodePackage,
         body);
         if (_p4.ctor === "Err") {
               return $Component$PackagePreview.Fail($Maybe.Just("Could not parse file contents as Elm docs."));
            } else {
               return $Component$PackagePreview.LoadDocs(_p4._0);
            }
      };
      return A2($Signal.map,
      function (_p5) {
         return UpdatePreview(toDocs(_p5));
      },
      uploads);
   }();
   var app = $StartApp.start({init: init
                             ,view: view
                             ,update: update
                             ,inputs: _U.list([docsUploads])});
   var main = app.html;
   var worker = Elm.Native.Task.make(_elm).performSignal("worker",
   app.tasks);
   return _elm.Page.PreviewDocumentation.values = {_op: _op
                                                  ,app: app
                                                  ,main: main
                                                  ,docsUploads: docsUploads
                                                  ,Model: Model
                                                  ,init: init
